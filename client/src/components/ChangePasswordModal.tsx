...
export default function ChangePasswordModal({ onClose, onSave, error }: ChangePasswordModalProps) {
  ...
  return (
    <div className="fixed inset-0 bg-black bg-opacity-75 flex items-center justify-center z-[60]">
      <div className="bg-gray-800 rounded-lg p-6 w-[500px] shadow-2xl border border-gray-700">
        ...
        <div className="space-y-4">
          <div>
            <label className="block text-sm font-medium text-gray-300 mb-2">Current Admin Password</label>
            <input
              type="password"
